...
import "../../amb/test/BeaconLightClientMock.sol";
...
contract BridgeTest is Test {
    ...
    function testDeposit() public {
        ...
        AMB home = new AMB(dummyForeignLC, 2000000, dummyForeign);
        ...
        deposit.deposit(depositRecipient, 5, address(token));
        bytes32 sentMsgHash = home.messages(0);
        assertEq(sentMsgHash != bytes32(0), true);
    }

    function testMint() public {
        IERC20Ownable mytoken = new SuccinctToken();
	...
	function testWithdraw() public {
        ...
        BeaconLightClientMock homeLC = new BeaconLightClientMock();
        vm.chainId(100); // Want to deploy AMB and withdraw on Gnosis chain
        AMB foreign = new AMB(address(homeLC), 2000000, deployedAMB);
